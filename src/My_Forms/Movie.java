...
public class Movie extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Malignant", "Star Wars", "Seven", "Warcraft" }));

        jComboBox2.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Star Cineplex", "Blockbuster", "Purobi", "Bolaka" }));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "10.00 AM", "12.00 PM", "2.00 PM", "4.00 PM", "6.00 PM" }));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "18-09-2021", "17-09-2021", "16-09-2021" }));
     ...
     public void workWithDatabase()
    {
       ...
       String d=jTextField1.getText();
        ...
        int N2=N1;
         N1*=100;
       //new Receipt(a,b,e,d,N1,f).setVisible(true);
        
      if(N2<10 && N2>0)
        
         {  
             this.setVisible(false);  new Receipt(a,b,e,d,N1,f).setVisible(true); 
         ...
         try
   {
    ...
    //new Receipt(a,b,e,d).setVisible(true);
       while(rs.next())
       {
